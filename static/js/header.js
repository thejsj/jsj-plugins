/*! jsj-9 - v0.1.0 - 2014-07-03 *//* Modernizr 2.8.2 (Custom Build) | MIT & BSD
...
window.Modernizr = function(a, b, c) {
    ...
    e.mq = z, e.hasEvent = A, e.testProp = function(a) {
        return H([ a ]);
    }, e.testAllProps = J, e.testStyles = y, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + v.join(" ") : ""), 
    e;
...
if (Modernizr.addAsyncTest !== undefined) {
    Modernizr.addAsyncTest(function() {
        ...
        setTimeout(function() {
            var mix_blend_mode;
            try {
                mix_blend_mode = Modernizr.addTest("bgblendmode", mix_blend_mode);
            } catch (err) {
